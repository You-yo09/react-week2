...
const handleLogin = (e) => {
  e.preventDefault(); //使用enter登入onSubmit事件
  //console.log(account);
...
const checkUaerLogin = async () => {
  ...
  return (
   ...
   {isAuth ? (<div className="container py-5">
      <div className="row">
        <div className="col-6">
          <button onClick={checkUaerLogin} className='btn btn-success mb-5' type="button">檢查使用者是否登入</button>
          <h2>產品列表</h2>
